...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <div class="container ">
      ...
      <a class="style active " href ="shop.php">ONLINE SHOP</a>
      <br>
    </div>
    ...
    // Create connection
      ...
      <div class="row my-4">
        <div class="col-lg-4">
          ...
          <img class="img-fluid rounded" src="../img/gallery/shop/cleaning.jpg" alt="">
        </div>
        <!-- /.col-lg-8 -->
        <div class="col-lg-8">
          <h1><?php
        ...
        <input type="hidden" name="cmd" value="_s-xclick">
        <input type="hidden" name="hosted_button_id" value="Z4DLUCJPMKCR4">
